 ...
 * @author HP
 */
@WebServlet(name = "ConfirmOrderController", urlPatterns = {"/ConfirmOrderControl"})
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (order != null) {
                ...
                if (result > 0) {
                    response.sendRedirect("OrderHistoryStaffControl?success=Confirm order successfully");
                } else {
                    response.sendRedirect("OrderHistoryStaffControl?error=Confirm order fail");
                }
            } else {
