 ...
 * @author HP
 */
@WebServlet(value ="/OrderHistoryStaffControllerManagement")

public class OrderHistoryStaff_ManagementControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/OrderHistoryStaffManagement.jsp").forward(request, response);
