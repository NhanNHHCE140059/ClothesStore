...
<html lang="en">
    ...
    <body>
        ...
        <div class="content">
                ...
                <div class="section-padding-100" style="padding-top:24px">
                    ...
                    <div class="search-form-container">
                        ...
                        <form action="OrderDetailStaffControl" method="get" id="searchForm">
                            ...
                            <div class="button-group">
                                ...
                                <a style="height:20px;padding: 3px 8px;" href="${pageContext.request.contextPath}/OrderDetailStaffControl?orderIds=${orderIds}" class="reset-button">Reset</a>
                            </div>
                        </form>
                    </div>
